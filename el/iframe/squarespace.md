...
1. Αντιγράψτε τον κωδικό HTML <strong>επιλέγοντας</strong> τον μη κερδοσκοπικό οργανισμό που θέλετε να προωθήσετε από τη [Σελίδα Αντιγραφής Widget](https://givelink.app/charities/widget-gen)
   ...
   ![Αντιγραφή Κωδικού](/assets/widget-gen.png)
...
5. Τοποθετήστε το κουμπί στη σελίδα. Μπορείτε ελεύθερα να προσαρμόσετε χρώματα και γραμματοσειρά σύμφωνα με τον ιστότοπό σας. Βεβαιωθείτε ότι η Παρότρυνση για Δράση είναι <strong>"Give in-kind"</strong>, <strong>"View our Needs"</strong> ή κάτι παρόμοιο.
